        ...
        for (Sorter algorithm : algorithms) {
            ...
            for (int w = 0; w < warmupTrials; w++) {
                ...
                if (currentPercent != lastPercent) {
                    String progress = "[Warming up JIT Compiler... " + currentPercent + "%]";
                    // Use \r to return to start, and \u001b[K at the END to wipe lingering
                    // characters
                    System.out.format("\r" + formatString + " %s\u001b[K", stylizedName, "-", "-", "-", progress);
                    System.out.flush();
            ...
            if (failed) {
                ...
                System.out.format(formatString + "\n", stylizedName, (int) avgComparisons, (int) avgExchanges,
                        (int) avgTime);
            }
        }
